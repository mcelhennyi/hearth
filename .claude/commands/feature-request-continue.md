...
2. Open **`handoffs/`** (newest dated files first), then **`serial-diary.md`** and **`parallel/*`** (and **`DIARY.md`** if present); continue from the last incomplete **stage** (intake, design, tickets, develop prompts, closeout).
