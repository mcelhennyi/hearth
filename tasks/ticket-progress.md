...
| T-FR-0002-02 | Mantle PWA bones (manifest + SW + nav) | done | done | done | `FR-0002`. `apps/hub/web`: Vite+TS+Tailwind+Vite-PWA; Vitest breakpoint + SW registration; CI hub-web + Lighthouse 11 PWA ≥90; Compose serves `apps/hub/web/dist`. VAL server-first notes in `serial-diary.md`. |
