...
| T-FR-0004-15 | Admin user management API and settings UI | done | done | done | `FR-0004` multi-user extension. Admin-only user list/create/update/disable/enable/roles/reset APIs, final-admin safety, audit events, and Settings Account user-management UI. Validation: focused users 32 passed; adjacent backend 65 passed; full backend 349 passed, 3 skipped; web 66 passed; web build and targeted Settings lint passed. Full web lint remains blocked by pre-existing non-T15 lint debt. |
| T-FR-0004-16 | Multi-user E2E and compliance changelog refresh | done | done | done | `FR-0004` multi-user capstone. Stitched first-admin/second-user/protected-plugin E2E, dense Kindling multi-user compliance changelog, Pi/operator docs, and stale PR #56 closeout/handoff language refreshed. Validation: backend 351 passed, 3 skipped; web test/build passed; install smoke passed; full web lint still blocked by pre-existing non-T16 FR-0006 lint debt. |
