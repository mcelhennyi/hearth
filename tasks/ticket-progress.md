...
| T-FR-0006-02 | Dashboard layout API | done | done | done | `FR-0006`. GET/PUT `/api/dashboard/layout`; default layout; 409 collision; 422 validation; 10 pytest via `./develop test`. OpenAPI `/api/dashboard/layout`. Branch `feat/FR-0006-design-language-T-FR-0006-02-dashboard-layout`. |
