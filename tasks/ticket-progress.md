...
| T-FR-0006-05 | Plugin frame state UI | done | done | done | `FR-0006`. Frame state machine + overlays; 13 Vitest (frame + bridge frame filter); PR → `feat/FR-0006-design-language`. |
