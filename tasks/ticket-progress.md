...
| T-FR-0006-02 | Dashboard layout API | done | done | done | `FR-0006` **impl**. Part of RW-U1. Deps: none. Branch `feat/FR-0006-design-language-T-FR-0006-02-dashboard-layout`. |
