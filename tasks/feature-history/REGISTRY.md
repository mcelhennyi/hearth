...
| FR-0006 | `FR-0006-design-language/` | `done` | **`T-FR-0006-01`** … **`T-FR-0006-15`** in [`FR-0006-design-language/tickets.md`](FR-0006-design-language/tickets.md) | **Feature-complete** on `feat/FR-0006-design-language` @ `6812b38` (2026-05-21). [**PR #46**](https://github.com/mcelhennyi/hearth/pull/46) to **`main`** pending. Closeout: [`FR-0006-design-language/90-closeout.md`](FR-0006-design-language/90-closeout.md). **`@kindling/mantle`** v0.1.0; tag **`kindling-mantle-v0.1.0`** after **`NPM_TOKEN`**. |
