...
| FR-0002 | `FR-0002-iphone-pwa-prototype/` | `done` | **`T-FR-0002-01`** … **`T-FR-0002-04`** in [`FR-0002-iphone-pwa-prototype/tickets.md`](FR-0002-iphone-pwa-prototype/tickets.md) | **Merged to `main`** via [**PR #3**](https://github.com/mcelhennyi/hearth/pull/3) (2026-05-20). Pi + iPhone TLS/push validated. Operator guide: **`SETUP.md`**. Report: [`40-prototype-report.md`](FR-0002-iphone-pwa-prototype/40-prototype-report.md). Mac mini validation **later phase**. |
