...
| FR-0004 | `FR-0004-centralized-users-auth/` | `done` | **`T-FR-0004-01`** … **`T-FR-0004-16`** in [`FR-0004-centralized-users-auth/tickets.md`](FR-0004-centralized-users-auth/tickets.md) | Feature branch complete on `feat/FR-0004-centralized-users-auth`; multi-user local auth correction landed through `T-FR-0004-16`. [**PR #56**](https://github.com/mcelhennyi/hearth/pull/56) pending human merge to `main`. Closeout: [`90-closeout.md`](FR-0004-centralized-users-auth/90-closeout.md). |
