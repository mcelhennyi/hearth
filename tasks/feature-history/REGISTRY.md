...
| FR-0004 | `FR-0004-centralized-users-auth/` | `in-progress` | **`T-FR-0004-01`** … **`T-FR-0004-10`** in [`FR-0004-centralized-users-auth/tickets.md`](FR-0004-centralized-users-auth/tickets.md) | Built-in **`hearth-users`** + gateway auth. Resumed 2026-05-26 after design audit; next implementation ticket **`T-FR-0004-02`**. |
