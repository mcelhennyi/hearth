...
| FR-0004 | `FR-0004-centralized-users-auth/` | `in-progress` | **`T-FR-0004-01`** … **`T-FR-0004-16`** in [`FR-0004-centralized-users-auth/tickets.md`](FR-0004-centralized-users-auth/tickets.md) | Reopened 2026-05-26 for multi-user local auth. `T-FR-0004-02`…`10` landed the single-account centralized-auth slice on `feat/FR-0004-centralized-users-auth`; [**PR #56**](https://github.com/mcelhennyi/hearth/pull/56) remains pending until `T-FR-0004-11`…`16` are complete. |
