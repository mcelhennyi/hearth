...
| FR-0004 | `FR-0004-centralized-users-auth/` | `done` | **`T-FR-0004-01`** … **`T-FR-0004-10`** in [`FR-0004-centralized-users-auth/tickets.md`](FR-0004-centralized-users-auth/tickets.md) | **Feature-complete** on `feat/FR-0004-centralized-users-auth` (2026-05-26). [**PR #56**](https://github.com/mcelhennyi/hearth/pull/56) to **`main`** pending. Closeout: [`FR-0004-centralized-users-auth/90-closeout.md`](FR-0004-centralized-users-auth/90-closeout.md). Built-in **`hearth-users`** + gateway auth. |
...
| FR-0006 | `FR-0006-design-language/` | `done` | **`T-FR-0006-01`** … **`T-FR-0006-15`** in [`FR-0006-design-language/tickets.md`](FR-0006-design-language/tickets.md) | **Feature-complete** on `feat/FR-0006-design-language` @ `6812b38` (2026-05-21). PR to **`main`** pending. Closeout: [`FR-0006-design-language/90-closeout.md`](FR-0006-design-language/90-closeout.md). |
