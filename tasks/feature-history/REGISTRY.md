...
| FR-0003 | `FR-0003-hearth-pi-docker-cli/` | `parked` | **`T-FR-0003-01`** … **`T-FR-0003-13`** in [`FR-0003-hearth-pi-docker-cli/tickets.md`](FR-0003-hearth-pi-docker-cli/tickets.md) | **Implementation deferred until FR-0002 closes** (operator choice 2026-05-09, option A). Intake + L0 design + tickets on `main` stay authoritative; open **`feat/FR-0003-hearth-pi-docker-cli`** when starting build-out. Docker Compose Pi install, `./install`, `hearth` + per-plugin `plugin` CLI. |
