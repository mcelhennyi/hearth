...
| T-FR-0003-02 | Install layout: `hearth/`, VERSION.json, README | Story | T-FR-0003-01 | Define directory tree, manifests, top-level minimalism; document env vars. | P0 | [details](tickets.md#t-fr-0003-02--install-layout-hearth-versionjson-readme) |
