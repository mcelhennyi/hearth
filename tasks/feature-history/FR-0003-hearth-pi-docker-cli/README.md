...
**Status:** `done` — merged to **`main`** via [**PR #13**](https://github.com/mcelhennyi/hearth/pull/13) (2026-05-18). See [`90-closeout.md`](90-closeout.md) and [`REGISTRY.md`](../REGISTRY.md).  
...
**Schedule:** Closed. Operator guide: repo-root [**`SETUP.md`](../../../SETUP.md)**.
...
| [`../../../SETUP.md`](../../../SETUP.md) | Pi Docker-profile install validation (operator) |
| [`90-closeout.md`](90-closeout.md) | Feature closeout (post-merge) |
