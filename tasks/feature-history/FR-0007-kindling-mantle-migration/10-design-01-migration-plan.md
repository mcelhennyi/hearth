...
- [x] T-FR-0007-02 moves the package source to `kindling/mantle/` and removes the Hearth-local source tree instead of keeping a mirror.
...
2. Move package source, tests, package metadata, and changelog from Hearth `packages/mantle/` into Kindling `mantle/`.
