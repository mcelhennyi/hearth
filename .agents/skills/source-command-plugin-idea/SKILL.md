---
name: "source-command-plugin-idea"
description: "Create or update a native Hearth plugin idea design page that can later become a .skeleton-initialized plugin repo mounted as a submodule."
---

# source-command-plugin-idea

Use this skill when the user asks to run the migrated source command `plugin-idea`.
